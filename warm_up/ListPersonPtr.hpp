...
#ifndef LISTPERSONPTR_HPP
#define LISTPERSONPTR_HPP
...
List_PersonPtr *List_PersonPtr_new(bool (*sort_style)(const PersonPtr &p1, const PersonPtr &p2))
{
